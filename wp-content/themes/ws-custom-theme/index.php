 ...
 ?>
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    ...
                    <img src="<?php bloginfo('template_directory');?>/img/home.png" alt="" class="home__img">
                </div>
            </section>
                ...
                <div class="app__container bd-grid">
                    <div class="app__data">
                        ...
                        <div class="app__stores">
                            <a href="#"><img src="<?php bloginfo('template_directory');?>/img/app1.png" alt="" class="app__store"></a>
                            <a href="#"><img src="<?php bloginfo('template_directory');?>/img/app2.png" alt="" class="app__store"></a>
                        </div>
                    </div>

                    <img src="<?php bloginfo('template_directory');?>/img/movil-app.png" alt="" class="app__img">
                </div>
            </section>
